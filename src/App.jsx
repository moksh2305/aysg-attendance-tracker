...
html.light .main{background:rgba(242, 237, 208, 0.6);border:1px solid rgba(255,255,255,0.8);box-shadow:0 16px 40px rgba(92,64,51,0.05), inset 0 0 0 1px rgba(255,255,255,0.5)}
